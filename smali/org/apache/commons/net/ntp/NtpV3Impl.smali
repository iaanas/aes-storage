...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v0, Lorg/apache/commons/net/ntp/NtpV3Impl;

    .line 635
    .local v0, "other":Lorg/apache/commons/net/ntp/NtpV3Impl;
    iget-object v1, p0, Lorg/apache/commons/net/ntp/NtpV3Impl;->buf:[B

    iget-object v2, v0, Lorg/apache/commons/net/ntp/NtpV3Impl;->buf:[B
    ...
    .line 632
    .end local v0    # "other":Lorg/apache/commons/net/ntp/NtpV3Impl;
    :cond_2
    :goto_0
    const/4 v0, 0x0
...
.method public declared-synchronized getDatagramPacket()Ljava/net/DatagramPacket;
    ...
    .line 586
    .end local p0    # "this":Lorg/apache/commons/net/ntp/NtpV3Impl;
    :cond_0
    iget-object v0, p0, Lorg/apache/commons/net/ntp/NtpV3Impl;->dp:Ljava/net/DatagramPacket;
    :try_end_0
...
.method public setDatagramPacket(Ljava/net/DatagramPacket;)V
    ...
    .line 608
    .local v2, "dp":Ljava/net/DatagramPacket;
    ...
    :goto_0
    invoke-virtual {v2, v4}, Ljava/net/DatagramPacket;->setPort(I)V

    .line 611
    iget-object v4, p0, Lorg/apache/commons/net/ntp/NtpV3Impl;->buf:[B

    invoke-virtual {v2, v4}, Ljava/net/DatagramPacket;->setData([B)V

    .line 612
    return-void

    .line 599
    .end local v0    # "incomingBuf":[B
    .end local v1    # "len":I
    .end local v2    # "dp":Ljava/net/DatagramPacket;
    .end local v3    # "port":I
    :cond_2
